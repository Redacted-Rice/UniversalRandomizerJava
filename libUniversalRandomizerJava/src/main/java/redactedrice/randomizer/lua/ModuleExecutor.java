...
public class ModuleExecutor {
    ...
    private LuaTable convertArgumentsToLuaTable(Module metadata, Map<String, Object> arguments) {
        ...
        if (arguments != null) {
            ...
            for (Map.Entry<String, Object> entry : arguments.entrySet()) {
                ...
                if (argType != null && argType.getBaseType() == TypeDefinition.BaseType.GROUP) {
    ...
    private String formatLuaError(Module metadata, LuaError e) {
    ...
    private String formatJavaError(Module metadata, Exception e) {
        StringBuilder sb = new StringBuilder();
